...
if __name__ == "__main__":
    model_tag = "vgg16"
    block_name_to_freeze = "block3"
    model_package = tf.keras.applications.vgg16
    original_model = model_package.VGG16

    # Data generator
    data_generator = DataGenerator(
        TRAIN_DATA_DIR, preprocessing_function=model_package.preprocess_input
    )
    ...
    model, base = build_transfer_model(
        IMAGE_SHAPE, training_dataset.num_classes, original_model
    )
    model.summary()
